...
const DETAILS_DATA: Record<string, InsuranceDetailContent> = {
  silson: {
    ...
    leadSummary: '실손보험의 기본 개념과 가입·변경 전 확인해야 할 사항을 이해하기 쉽게 안내합니다. HK금융파트너스 경인사업본부 목동지점은 30여 개 제휴 보험사의 실손의료보험 약관과 4세대 전환 조건을 객관적으로 비교 분석합니다. 보험 상담이 필요한 고객부터 새로운 금융 커리어를 시작하려는 보험설계사 지망생까지 모두에게 신뢰할 수 있는 명확한 기준을 제시합니다.',
    icon: Stethoscope,
    description: [
  ...
  health: {
    ...
    leadSummary: '종합 건강보험의 기본 개념과 진단비·수술비·입원비 구성 시 확인해야 할 사항을 이해하기 쉽게 안내합니다. HK금융파트너스 경인사업본부 목동지점은 질병과 상해를 아우르는 균형 잡힌 보장분석과 합리적인 보험료 설계를 지원합니다. 보험 상담이 필요한 고객과 보험설계사로 안착하려는 분께 객관적인 정보를 제공합니다.',
    icon: Activity,
    description: [
  ...
  cancer: {
    ...
    leadSummary: '암, 뇌혈관질환, 허혈성 심장질환 등 치료비 부담이 큰 3대 질병 보장의 기본 개념과 최신 치료 특약을 이해하기 쉽게 안내합니다. HK금융파트너스 경인사업본부 목동지점은 보장 공백 없는 치료비 플랜과 체계적인 비교 분석을 제공합니다. 보험 상담이 필요한 고객과 보험설계사를 시작하려는 분을 함께 지원합니다.',
    icon: ShieldAlert,
    description: [
  ...
  'whole-life': {
    ...
    leadSummary: '종신보험의 기본 개념과 평생 사망보장 및 상속자금 플랜 전 확인해야 할 사항을 이해하기 쉽게 안내합니다. HK금융파트너스 경인사업본부 목동지점은 무리한 가입 대신 가계 재정에 최적화된 맞춤 설계를 도와드립니다. 보험 상담이 필요한 고객과 보험설계사를 시작하려는 사람을 위한 체계적인 가이드를 제공합니다.',
    icon: ShieldCheck,
    description: [
  ...
  life: {
    ...
    leadSummary: '정기보험과 생명보험의 기본 개념과 집중 경제활동기 사망보장 설계 시 확인해야 할 사항을 이해하기 쉽게 안내합니다. HK금융파트너스 경인사업본부 목동지점은 합리적인 비용으로 가족의 미래를 지키는 맞춤형 가성비 플랜을 제시합니다. 보험 상담이 필요한 고객과 보험설계사를 시작하려는 분을 함께 지원합니다.',
    icon: HeartHandshake,
    description: [
  ...
  pension: {
    ...
    leadSummary: '연금보험과 노후준비의 기본 개념과 은퇴 이후 현금흐름 구축 전 확인해야 할 사항을 이해하기 쉽게 안내합니다. HK금융파트너스 경인사업본부 목동지점은 세액공제와 비과세 혜택을 다각도로 분석하여 안정적인 노후 파이프라인 설계를 돕습니다. 보험 상담이 필요한 고객과 보험설계사를 시작하려는 사람을 함께 지원합니다.',
    icon: Coins,
    description: [
  ...
  fire: {
    ...
    leadSummary: '화재 및 재산보험의 기본 개념과 주택·사업장 자산 보호 전 확인해야 할 사항을 이해하기 쉽게 안내합니다. HK금융파트너스 경인사업본부 목동지점은 화재 손해와 이웃집 배상책임까지 꼼꼼하게 방어할 수 있는 보장을 안내합니다. 보험 상담이 필요한 고객과 보험설계사를 시작하려는 분을 함께 지원합니다.',
    icon: Building2,
    description: [
